...
def main(kappa):
    ...
    plt.legend()
    filename = f'plot_varying_drug_dynamics_kappa={kappa}.png'
    ...
    for i in range(len(Nc1)):
        if Nc1[i] > 1.25*initial_tumor_size:
            print(f'Time to reach 125% of initial tumor size: {Tc1[i]}')
            print("for kappa = ", kappa)
            gammma = (Tc1[i] - 435.200000000030469) / 435.20000000003046
            print("gamma = ", gammma)
            break
